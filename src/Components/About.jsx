    ...
    <div className='w-full min-h-screen flex flex-col md:flex-row pb-4 md:py-6 lg:pb-8 px-2 md:px-6 lg:px-8'>
      <div className='w-full text-black h-full flex flex-col gap-4 md:flex-row px-2 md:px-6 lg:px-8 xl:px-10'>
        <div className='w-full md:w-1/2 h-full flex flex-col'>
          ...
          <p className='pt-2 lg:text-lg text-gray-600'><strong>Ishaal Enterprises,</strong> founded in January 2010, is a trusted name in telecom infrastructure, construction, 
            ...
            <p className='pt-2 lg:text-lg text-gray-600'>
            ...
            <p className='pt-2 lg:text-lg text-gray-600'>
            Our mission is to provide strategic and technical value to our Customers by designing, building and maintaining cost effective solutions for Pakistan’s leading Operators and Service Providers.
            </p>
        </div>
