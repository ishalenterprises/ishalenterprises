      ...
      <div className='w-full flex flex-col my-4 md:my-14 px-4 sm:px-3 md:px-8 items-center'>
        ...
        <div className='flex flex-col md:hidden xl:flex xl:flex-row mx-4 md:mx-0 gap-4 md:gap-4 lg:gap-8 pb-4 md:pb-14'>
          ...
          <div className='relative flex flex-col w-full xl:w-[18rem] mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] md:shadow-[0_0_5px_5px_rgba(28,38,39,0.08)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
            <div className="absolute -top-4 -left-4 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-lg font-semibold">1</div>
          ...
          <div className='relative flex flex-col w-full md:w-[13rem] lg:w-[15rem] xl:w-[18rem] mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] md:shadow-[0_0_5px_5px_rgba(28,38,39,0.08)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
            <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-lg font-semibold">2</div>
          ...
          {/* Box 3 */}
          <div className='relative flex flex-col w-full md:w-[13rem] lg:w-[15rem] xl:w-[18rem] mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] md:shadow-[0_0_5px_5px_rgba(28,38,39,0.08)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
            <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-lg font-semibold">3</div>
          ...
          {/* Box 4 */}
          <div className='relative flex flex-col w-full md:w-[13rem] lg:w-[15rem] xl:w-[18rem] mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] md:shadow-[0_0_5px_5px_rgba(28,38,39,0.08)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
            <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-lg font-semibold">4</div>
        ...
        <div className='hidden md:flex flex-col xl:hidden gap-4 md:gap-8 lg:gap-8 py-8 md:py-16 pb-4'>
          ...
          <div className='flex gap-8'>
            ...
            <div className='relative flex flex-col w-1/2 mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
              <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-base font-semibold">1</div>
            ...
            {/* Box 2 */}
            <div className='relative flex flex-col w-1/2 mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
              <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-sm font-semibold">2</div>
          ...
          <div className='flex gap-8'>
            {/* Box 3 */}
            <div className='relative flex flex-col w-1/2 mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
              <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-sm font-semibold">3</div>
            ...
            {/* Box 4 */}
            <div className='relative flex flex-col w-1/2 mb-3 md:mb-0 shadow-[0_0_8px_8px_rgba(28,38,39,0.1)] items-center px-4 py-6 bg-gray-100 rounded-sm'>
              <div className="absolute -top-3 -left-3 bg-[rgb(37,83,177)] text-white w-12 h-12 flex items-center justify-center rounded-full text-sm font-semibold">4</div>
